...
# THIS is hard coded to pick up sample data
cur_epoch = 1599834600
# Replace for production with:
# cur_epoch = int(datetime.now().timestamp())

five_day_ago = cur_epoch - 432060
cur_epoch += 62400  # fail safe for different time zone issues


# return data in proper format
data = data_store.get_data_5day()
